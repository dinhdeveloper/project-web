...
$(window).on('load', function() {	
	...
	//Tost notification
	setTimeout(function() {
		Materialize.toast('<span>Xin chào Admin.</span>', 1500);
	}, 1500);
	// setTimeout(function() {
	// 	Materialize.toast('<span></span>', 1500);
	// }, 5000);
	// setTimeout(function() {
	// 	Materialize.toast('<span>Bạn có đơn hàng mới.</span><a class="btn-flat yellow-text" href="#">Read<a>', 3000);
	// }, 15000);
});
